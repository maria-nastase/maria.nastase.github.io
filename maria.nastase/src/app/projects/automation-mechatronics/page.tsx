...
const automationProjects: Project[] = [
  {
    ...
    longDescription:
      `This mobile robot cell was designed to automate 4 different burnishing machines using a Fanuc cobot to pick and place parts and to pull handles on machines. The system was designed to handle 15 different part types, most of which are in bulk using a 3D vision system. As well, custom extensions were made for the gripper so that it can pick up all parts in tight spaces. 
