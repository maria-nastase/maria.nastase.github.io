...
const automationProjects: Project[] = [
  {
    ...
    longDescription:
      ...
      A six-level mobile aluminum extrusion cart was designed to store the parts, requiring an operator to load and unload only once per shift. This was the best solution due to the lack of space in the area, the differing part sizes, and the amount of parts needed to be handled without operator intervention. The rack is easily adaptable to include extra storage space, a bin to place parts for inspection, and a bin that acts as a buffer station for finished parts.
